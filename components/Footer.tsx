    ...
    <footer className="bg-slate-950 text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
          ...
          {/* Navigation Links */}
          <div>
            <h4 className="font-extrabold text-white text-sm uppercase tracking-widest mb-8">{t.nav}</h4>
          ...
          {/* Contact Info Column */}
          <div>
            <h4 className="font-extrabold text-white text-sm uppercase tracking-widest mb-8">{t.info}</h4>
            <ul className="space-y-6 text-slate-400 text-sm">
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-niger-green flex-shrink-0" />
                <span>{COMPANY_INFO.phone}</span>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-niger-orange flex-shrink-0" />
                <a href={`mailto:${COMPANY_INFO.email}`} className="hover:text-white transition-colors">{COMPANY_INFO.email}</a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-blue-400 flex-shrink-0" />
                <span>{COMPANY_INFO.location}<br/>{COMPANY_INFO.address}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-900 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em]">
          ...
          <div className="flex gap-8">
             ...
             <span className="flex items-center gap-2 text-slate-400"><span className="text-niger-green">•</span> B2B & B2C EXPERTISE</span>
          </div>
        </div>
      </div>
    </footer>
